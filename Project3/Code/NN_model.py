...
wine = 1
scaler = 1
resampling = 2  # set to 2 for adasyn, 0 else
drop_classes = True  # remove classes 3 and 9
grid = False  # use grid paramters
training = False  # use training data as test data
...
model = KerasClassifier(
    ...
    act=best_parameters["act"],
    batch_size=best_parameters["batch_size"],
    decay=best_parameters["decay"],
    dropout=best_parameters["dropout"],
    epochs=best_parameters["epochs"],
    lr=best_parameters["lr"],
    nl1=best_parameters["nl1"],
    nl2=best_parameters["nl2"],
    nl3=best_parameters["nl3"],
    nn1=best_parameters["nn1"],
    nn2=best_parameters["nn2"],
    nn3=best_parameters["nn3"],
    verbose=1,
)  # l1=best_parameters["l1"] , l2=best_parameters["l2"] ,
