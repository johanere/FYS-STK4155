...
def load_wine_data(wine=1, scaler=0,resampling=0,drop_classes=True):
    ...
    if drop_classes==False and resampling>0:
        exit("Program aborted. Ccategory nine has too few neighbours for upsampling, set drop_classes=True, or resampling=0")
    ...
    if resampling==1:
        ...
        ada = ADASYN(random_state=42) #https://imbalanced-learn.readthedocs.io/en/stable/over_sampling.html
