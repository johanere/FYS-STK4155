...
dropout = [0.1] #har testa med 0
epochs=[10,50,100] # HAR bare testa med lavere
batch_size=[10,50,100]  # HAR bare testa med lavere



nl1 = [1]#, 1]  # ,2] # numbers of layers of type nl1
nl2 = [0]#,1]#, 1]  # ,2] # numbers of layers of type nl2
nl3 = [0]  # numbers of layers of type nl3 - not in use!

nn1 = [9] # ,8]#,20] # neurons in each layer of type nl1
nn2 = [7] #  neurons in each layer of type nl2 AAAAAAAA 6,7,8
nn3 = [0] # neurons in each layer of type nl3  - not in use!
...
grid = sklms.GridSearchCV(
    ...
    n_jobs=7,
    scoring="f1_weighted",
) # scoring='f1_weighted') - default uses estimator scoring use   neg_mean_absolute_error
